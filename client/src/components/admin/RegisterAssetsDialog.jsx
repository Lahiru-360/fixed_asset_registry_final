          ...
          : "border-muted focus:border-primary"
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  onClick={onClose}
                  disabled={loading}
                  className="flex-1 px-5 py-2.5 rounded-lg bg-muted text-foreground hover:bg-muted/80 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  Cancel
                </button>
                <button
