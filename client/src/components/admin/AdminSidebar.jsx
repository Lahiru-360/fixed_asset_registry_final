    ...
    <aside className="hidden lg:flex w-71.5 flex-col p-6 gap-8 bg-sidebar border-r border-muted shadow-sm">
      ...
      <nav className="flex-1 flex flex-col gap-1.5">
        ...
        <NavItem
          icon={Boxes}
          label="Assets"
          active={location.pathname === "/admin/assets"}
        ...
        <NavItem
          icon={TrendingDown}
          label="Depreciation"
          active={location.pathname === "/admin/depreciation"}
          onClick={() => navigate("/admin/depreciation")}
        />

        <NavItem
          icon={BarChart3}
          label="SOFP"
          active={location.pathname === "/admin/sofp"}
          onClick={() => navigate("/admin/sofp")}
        />
      </nav>
